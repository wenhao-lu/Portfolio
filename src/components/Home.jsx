      ...
      <div className="introContainer">
        <div className="intro">
          ...
          <div className="resumeWrap">
            ...
            <a href="https://www.linkedin.com/in/wenhao-kevin-l-6290b2145/" target="_blank" className="contactMobile">
              <img
            ...
            <a href="https://github.com/wenhao-lu" target="_blank" className="contactMobile">
              <img
